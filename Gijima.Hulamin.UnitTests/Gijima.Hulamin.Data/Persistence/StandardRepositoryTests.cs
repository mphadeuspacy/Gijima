...
namespace Gijima.Hulamin.UnitTests.Gijima.Hulamin.Data
{
    ...
    public class StandardRepositoryTests
    {
        ...
        private bool? TestDiscontinuedValid => false;
        ...
        {
            // Arrange
            _entity = new Product { Id = TestInvalidNegativeOne, Name = TestValidName, Discontinued = TestDiscontinuedValid };
        ...
        {
            // Arrange
            _entity = new Product { Id = 0, Name = TestValidName, Discontinued = TestDiscontinuedValid };
        ...
        {
            // Arrange
            _entity = new Product { Id = 1, Name = null, Discontinued = TestDiscontinuedValid };
        ...
        {
            // Arrange
            _entity = new Product { Id = 1, Name = string.Empty, Discontinued = TestDiscontinuedValid };
        ...
        {
            // Arrange
            _entity = new Product { Id = 1, Name = "  ", Discontinued = TestDiscontinuedValid };
        ...
        [TestMethod]
        public async Task Create_OnFailure_WhenTheProductIsIdAndNameAreValidButDiscontinuedIsNull_ThenDoesNotThrowXnException()
        {
            // Arrange
        ...
        [TestMethod]
        public async Task Create_OnFailure_WhenTheProductIsValidButTheNameAlreadyExistsInTheData_ThenDoesNotThrowXnException()
        {
            // Arrange
            _entity = new Product { Id = 1, Name = TestValidName, Discontinued = TestDiscontinuedValid };
            _standardRepository = new StandardRepository(_setUpSpecificationHandler, @"Data Source=.\;Initial Catalog=Northwind;Persist Security Info=True;User ID=sa;Password=Khsph01@gmailcom");
